        ...
        <div className="public-page min-h-screen bg-gray-50 font-sans text-gray-900 antialiased overflow-x-hidden pb-16 lg:pb-0 flex flex-col">
            ...
            <main id="services" className="flex-1 py-8 sm:py-12 pt-24 sm:pt-28 w-full">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 lg:px-6">
                        {/* Sidebar */}
                        <div className="lg:w-1/3">
                            ...
                            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden sticky top-24">
                                    ...
                                    <ul className="space-y-1">
                                        {['Multispeciality', 'ICU', 'NICU', 'Ultrasound', 'Neurosurgery', 'X-RAY', 'Pathology', 'Painless Normal Delivery', '24 hrs Delivery Service'].map((service, idx) => (
                                            <li key={idx} className="group">
                                                <a href={`#${service.toLowerCase().replace(/ /g, '-')}`} className="flex items-center p-2.5 rounded-lg hover:bg-beige-50 transition-colors duration-150">
                                                    <span className="text-beige-600 mr-3">
                                                        <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
                                                    </span>
                                                        <span className="font-medium text-gray-700 group-hover:text-beige-700">{service}</span>
                                                </a>
                                            </li>
                                        ))}
                                    </ul>
                                ...
                                {/* Hours Card */}
                                <div className="mt-6 border-t border-gray-200 pt-5 px-5 pb-5">
                                    ...
                                    <div className="mt-4 bg-beige-50 border border-beige-100 rounded-lg p-3">
                                ...
                                <div className="mt-4 px-6 pb-6">
                                    <div className="bg-gray-50 rounded-lg border border-gray-200 p-4">
                                        ...
                                        <Link href={route('contact.page')} className="bg-beige-600 hover:bg-beige-700 text-white text-center rounded-lg border border-beige-600 py-2 px-4 block transition-colors duration-150 w-full sm:w-auto">
                                            Call Now
                                        </Link>
                                    </div>
                                </div>
                        ...
                        <div className="lg:w-2/3 space-y-5">
                            ...
                            <div id="multispeciality" className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                            ...
                            <div id="icu" className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                <div className="md:flex">
                                    <div className="md:w-1/3 relative overflow-hidden bg-gray-200 min-h-[200px]">
                            ...
                            <div id="nicu" className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                <div className="md:flex">
                                    <div className="md:w-1/3 relative overflow-hidden bg-gray-200 min-h-[200px]">
                            ...
                            <div id="ultrasound" className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                <div className="md:flex">
                                    <div className="md:w-1/3 relative overflow-hidden bg-gray-200 min-h-[200px]">
                            ...
                            <div id="neurosurgery" className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                <div className="md:flex">
                                    <div className="md:w-1/3 relative overflow-hidden bg-gray-200 min-h-[200px]">
                            ...
                            <div id="x-ray" className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                <div className="md:flex">
                                    <div className="md:w-1/3 relative overflow-hidden bg-gray-200 min-h-[200px]">
                            ...
                            <div id="pathology" className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                <div className="md:flex">
                                    <div className="md:w-1/3 relative overflow-hidden bg-gray-200 min-h-[200px]">
                            ...
                            <div id="painless-normal-delivery" className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                <div className="md:flex">
                                    <div className="md:w-1/3 relative overflow-hidden bg-gray-200 min-h-[200px]">
                            ...
                            <div id="24-hrs-delivery-service" className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                <div className="md:flex">
                                    <div className="md:w-1/3 relative overflow-hidden bg-gray-200 min-h-[200px]">
