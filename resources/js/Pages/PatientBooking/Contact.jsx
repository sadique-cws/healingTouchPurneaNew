...
export default function Contact({ contact_email, contact_phone, whatsapp_number, address, map_url, facebook_link, instagram_link, twitter_link }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900 antialiased overflow-x-hidden">
            ...
            <div className="py-10 px-4 sm:px-6 lg:px-8 max-w-6xl mt-24 mx-auto pt-32">
                <div className="text-center mb-10">
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Get in Touch</h1>
                    <p className="text-gray-600 max-w-2xl mx-auto">We're here to help and answer any questions you might have. We look forward to hearing from you.</p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="md:col-span-2">
                        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                            <div className="bg-gradient-to-r from-beige-600 to-beige-800 py-6 px-8 relative">
                                <div className="absolute right-0 top-0 w-24 h-24 bg-white opacity-10 rounded-full -translate-y-1/3 translate-x-1/3"></div>
                                <h3 className="text-2xl font-bold text-white relative z-10">Contact Information</h3>
                            </div>
                            ...
                            <div className="p-8">
                                <div className="grid sm:grid-cols-2 gap-8">
                                    ...
                                    <div className="flex items-start">
                                        <div className="bg-beige-100 p-3 rounded-full mr-4 flex-shrink-0">
                                        ...
                                        <div>
                                            ...
                                            <a href={`tel:${contact_phone}`} className="text-beige-600 font-medium text-lg hover:text-beige-800 transition-colors">{contact_phone}</a>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <a href={`mailto:${contact_email}`} className="text-beige-600 font-medium text-lg hover:text-beige-800 transition-colors">{contact_email}</a>
                                    ...
                                    {whatsapp_number && (
                                        <div className="flex items-start">
                                            <div className={`${isAvailable ? 'bg-green-100' : 'bg-gray-100'} p-3 rounded-full mr-4 flex-shrink-0`}>
                                            ...
                                            <div>
                                                ...
                                                {isAvailable ? (
                                                    <a href={`https://wa.me/${whatsapp_number.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-green-600 font-medium text-lg hover:text-green-800 transition-colors flex items-center">
                                                        {whatsapp_number}
                                                ...
                                                <p className="text-gray-500 text-sm mt-1">{statusText}</p>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <p className="font-semibold text-gray-800 text-lg">Support Hours</p>
                    ...
                    <div className="md:col-span-1">
                        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden h-full">
                            <div className="p-4">
                                ...
                                <div className="aspect-video relative rounded-lg overflow-hidden border border-gray-200 min-h-[300px]">
                                    <iframe
                                ...
                                <div className="bg-beige-50 rounded-lg p-4 mt-4">
