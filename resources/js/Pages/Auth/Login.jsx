    ...
    return (
        <div className="relative min-h-screen bg-gray-50 text-gray-900 antialiased overflow-x-hidden flex flex-col px-4 py-6">
            ...
            <main className="relative z-10 mx-auto flex w-full max-w-md flex-1 items-center">
                    <section className="w-full rounded-2xl border border-gray-200 bg-white/95 backdrop-blur-sm p-5 md:p-6 shadow-sm">
                        <div className="flex items-center justify-between gap-3">
                            <Link href="/" className="flex items-center gap-3">
                                <ApplicationLogo className="h-11 w-11 shrink-0 text-beige-700" />
                                <div className="leading-tight">
                                    <p className="text-[10px] font-black uppercase tracking-[0.24em] text-beige-700">Patient Portal</p>
                                    <h2 className="mt-1 text-xl font-black tracking-tight text-gray-900">Healing Touch</h2>
                                </div>
                            </Link>
                            <Link href="/" className="rounded-full border border-gray-200 bg-gray-50 px-3.5 py-2 text-[11px] font-black uppercase tracking-[0.16em] text-gray-700">Home</Link>
                        </div>
                        ...
                        <form onSubmit={submit} className="mt-6 space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-gray-200 bg-gray-50 px-4 py-3.5 font-medium outline-none focus:border-beige-700 focus:ring-2 focus:ring-beige-700/10"
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full rounded-lg bg-beige-700 px-4 py-3.5 text-sm font-black uppercase tracking-[0.2em] text-white shadow-lg transition-all active:scale-[0.99] disabled:opacity-60"
                            >
