            ...
            <div className="space-y-5 md:space-y-8">
                <div className="flex flex-col gap-4 lg:flex-row lg:justify-between lg:items-end">
                    ...
                    <button 
                        ...
                        className="w-full sm:w-auto justify-center bg-[#0d9488] hover:bg-[#0f766e] text-white px-5 py-3 rounded-xl font-black text-sm tracking-widest uppercase transition-all shadow-lg shadow-teal-500/20 active:scale-95 flex items-center gap-2"
                    >
