            ...
            <div className="space-y-5 md:space-y-8">
                <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-end">
                    ...
                    <button 
                        ...
                        className="hidden sm:inline-flex w-full sm:w-auto justify-center bg-slate-900 hover:bg-black text-white px-5 py-3 rounded-xl font-black text-sm tracking-widest uppercase transition-all shadow-lg active:scale-95 items-center gap-2"
                    >
                ...
                <button
                    onClick={openAddModal}
                    className="sm:hidden fixed bottom-4 right-4 z-40 h-12 w-12 rounded-full bg-slate-900 text-white shadow-xl flex items-center justify-center"
