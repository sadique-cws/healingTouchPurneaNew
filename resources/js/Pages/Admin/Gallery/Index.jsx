    ...
    return (
        <AdminLayout>
            ...
            <div className="space-y-8">
                <div>
                    <h2 className="text-3xl font-black text-slate-800 tracking-tight">Clinical Visuals</h2>
                    <p className="text-slate-500 font-medium">Manage hospital gallery, facility photos, and events</p>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {/* Upload Section */}
                    <div className="lg:col-span-1">
                        <form onSubmit={submit} className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 space-y-6 sticky top-8">
                            <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Add New Visual</h3>
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full px-5 py-3 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-teal-500 transition-all font-bold text-slate-700"
                            ...
                            <button 
                                type="submit" 
                                disabled={processing}
                                className="w-full py-4 bg-teal-600 hover:bg-teal-700 text-white rounded-2xl font-black text-sm uppercase tracking-widest transition-all shadow-xl shadow-teal-500/30 active:scale-95 disabled:opacity-50"
                            >
                    ...
                    <div className="lg:col-span-2">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            {galleries.map((img) => (
                                <div key={img.id} className="group relative bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-slate-100 aspect-video">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8">
                                        <p className="text-white font-black text-lg leading-tight uppercase tracking-tight">{img.title || 'Untitled Image'}</p>
                                        <div className="flex justify-between items-center mt-4">
                                            ...
                                            <button 
                                                ...
                                                className="p-3 bg-red-600 text-white rounded-2xl hover:bg-red-700 transition-colors shadow-xl"
                                            >
