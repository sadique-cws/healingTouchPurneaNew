            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 xl:gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <form onSubmit={submit} className="bg-white p-6 md:p-7 rounded-2xl shadow-sm border border-slate-100 space-y-5 sticky top-6">
                            ...
                            <div>
                                ...
                                <div className="p-6 bg-slate-50 rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center text-center">
                                    <div className="w-11 h-11 bg-white rounded-xl shadow-sm flex items-center justify-center text-slate-300 mb-4">
                            ...
                            <button 
                                type="submit" 
                                disabled={processing}
                                className="w-full py-3.5 bg-teal-600 hover:bg-teal-700 text-white rounded-xl font-black text-sm uppercase tracking-widest transition-all shadow-lg shadow-teal-500/20 active:scale-95 disabled:opacity-50"
                            >
                    ...
                    <div className="lg:col-span-2">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            {galleries.map((img) => (
                                <div key={img.id} className="group relative bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 aspect-video">
